        ...
        <div className="rounded-2xl bg-[#101010] p-5 ring-1 ring-white/10">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white/90">
              {name} <span className="text-white/50">({symbol})</span>
            </h1>
          ...
          <div className="relative mt-2 h-[260px] overflow-hidden rounded-xl bg-gradient-to-b from-yellow-300/15 via-yellow-400/10 to-transparent">
            ...
            >
              ...
              <path
                d="M0,170 L40,160 L80,140 L120,150 L160,120 L200,135 L240,100 L280,150 L320,140 L360,160 L400,130 L440,110 L480,140 L520,120 L560,130 L600,100"
                stroke="#fde047"
                strokeWidth="3"
                fill="url(#c)"
              />
          ...
          <div className="lg:col-span-7 rounded-2xl bg-[#0f0f0f] ring-1 ring-white/10">
            ...
            <ul className="divide-y divide-white/5">
              {[
                ...
                <li key={i} className="px-4 py-3 text-sm text-white/90">
                  {t}
                </li>
              ))}
            </ul>
